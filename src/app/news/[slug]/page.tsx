    ...
    <>
      <section className="relative min-h-[40vh] flex items-end overflow-hidden">
        ...
        <div className="container-luxury relative z-10 pb-16 pt-40">
          <FadeIn>
            <Link href="/news" className="text-primary text-sm flex items-center gap-2 mb-6 hover:gap-3 transition-all">
              <ArrowLeft className="w-4 h-4" /> Back to News
            </Link>
            <p className="text-primary text-xs uppercase tracking-[0.3em] mb-4">Press Release</p>
            <h1 className="text-display font-serif font-bold text-foreground">{title}</h1>
            <p className="text-sm text-neutral-400 mt-4">Published: January 2025</p>
          </FadeIn>
        </div>
      </section>
