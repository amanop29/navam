    ...
    <>
        ...
        <div className="container-luxury relative z-10 pb-20 pt-40">
          <FadeIn>
            ...
            <h1 className="text-hero font-serif font-bold text-brown-50">
              From Sketch
              <br />
              to <em className="italic gold-text">Sparkle</em>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <FadeIn key={step.num} delay={i * 0.1}>
                <div className="glass-card-hover p-8 h-full space-y-4 group">
                  <div className="flex items-center justify-between">
                    <step.Icon className="w-8 h-8 text-gold" />
                    <span className="text-3xl font-serif font-bold text-white/10 group-hover:text-gold/20 transition-colors">
                      {step.num}
                    </span>
                  </div>
      ...
      <section className="section-padding relative">
        ...
        <div className="container-luxury relative z-10 text-center">
          <FadeIn>
            <h2 className="text-display font-serif font-bold text-brown-50 mb-6">
              150+ <em className="italic gold-text">Master Artisans</em>
            </h2>
            <p className="text-brown-100/50 text-lg max-w-xl mx-auto mb-8">
